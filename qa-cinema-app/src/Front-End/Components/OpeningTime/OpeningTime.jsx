      ...
      <div className="container">
        <figure className="text-center">
          <blockquote className="blockquote">
            <p>
              "I am the type of person who eats all the popcorn while they're
              still going through the trailers"
            </p>
          </blockquote>
      ...
      <div className="row d-flex justify-content-around">
        ...
        <div className="card col-4 p-3 drop-shadow bg-dark text-white">
          ...
          <h3 className="text-center">
            What are you waiting for?<br></br>Visit Us Today
          </h3>
          ...
          <br />
          <img
            src="https://images.pexels.com/photos/3537844/pexels-photo-3537844.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
            alt="Popcorn"
          ></img>
        </div>
      </div>
