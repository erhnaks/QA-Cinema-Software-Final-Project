...
const Classifications = () => {
  return (
    <React.Fragment>
      ...
      <br></br>
      <p className="p-tag">
        All film classification decisions are based on the British Board of Film
        Classification's (BBFC) published and regularly updated guidelines.
      </p>
      <p className="p-tag">
        For more detailed information about BBFC rulings, and for information
        for parents regarding film classifications and their suitability, please
        visit British Board of Film Classification official website on:<br></br>
         <br></br>
        <a
          rel="noreferrer"
      ...
      <Accordion defaultActiveKey="">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <img src={tbc}></img>
            <p></p>
            In some instances films have not been certified by the time tickets
            are available online.
            <br></br>
            Child and Family tickets purchased before a film is certified as 15
            or over can be refunded. Please contact Guest Services before the
            performance for a refund, as admission may be refused on the day.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          <Accordion.Header>U - Universal - Suitalbe for all</Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="3">
          ...
          <Accordion.Body>
            ...
            showing.
            <br></br>
            Advice is given regarding the content of the film and the ADULT must
            decide if it is appropriate for the accompanying under 12. Please
            note: proof of age may be required.
            <p>
              Please visit British Board of Film Classification for more
              information.
            </p>
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            ...
            video work. Please note: proof of age may be required.
            <p>
              Please visit British Board of Film Classification for more
              information.
            </p>
