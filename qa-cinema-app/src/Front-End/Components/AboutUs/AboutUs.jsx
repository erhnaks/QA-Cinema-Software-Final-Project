          ...
          <div class='row d-flex justify-content-between mb-3'>
            {/* <div className id="col-md-4"> */}
              <Card style={{ width: '18rem' }} className='bg-dark drop-shadow'>
                <Card.Body>
                <Card.Img id="avatar" variant="top" src={billyAvatar} class="rounded-circle"
                        width="70"/>
            ...
            <Card style={{ width: '18rem' }} className='bg-dark drop-shadow'>
              <Card.Body>
              <Card.Img id="avatar" variant="top" src="https://icons.iconarchive.com/icons/jonathan-rey/star-wars-characters/256/R2D2-01-icon.png" class="rounded-circle"
                        width="70"/>
                <Card.Title id="AboutUs-title">
            ...
            <Card style={{ width: '18rem' }} className='bg-dark drop-shadow'>
              <Card.Body>
              <Card.Img id="avatar" variant="top" src={muhammadAvatar} class="rounded-circle"
                        width="70"/>
                <Card.Title id="AboutUs-title">
            ...
            <Card style={{ width: '18rem' }} className='bg-dark drop-shadow'>
              <Card.Body>
              <Card.Img id="avatar" variant="top" src={omarAvatar} class="rounded-circle"
                        width="70"/>
                <Card.Title id="AboutUs-title">
            ...
            <Card style={{ width: '18rem' }} className='bg-dark drop-shadow'>
              <Card.Body>
              <Card.Img id="avatar" variant="top" src={shakAvatar} class="rounded-circle"
                        width="70"/>
